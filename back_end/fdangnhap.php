...
<body>
	...
	if (isset($_POST['sb-dk'])) {//kiểm tra xem người dùng đã bấm nút đăng ký hay chưa, nếu người dùng bấm đăng ký điều hướng sang quan lý thành viên.
		...
		<form class="fLogin" method="post">
			...
			<div class="form-login">
				...
				<div class="form-group" id="sm">
					...
					<input type="submit" name="sb-dk"  value="Đăng Ký" class="form-control">
				</div>
				<a>Quên mật khẩu?</a>
			</div>
